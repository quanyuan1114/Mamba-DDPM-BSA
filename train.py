...
def parse_args():
    ...
    parser.add_argument('--input_channels', type=int, help='Number of MambaUNet channels')
    parser.add_argument('--depths', type=int, help='Number of encoder deepth')
    parser.add_argument('--depths_decoder', type=int, help='Number of decoder deepth')
    parser.add_argument('--drop_path_rate', type=int, help='Batch size for training')
    parser.add_argument('--load_ckpt_path', type=int, help='Path to MambaUNet training load weights')
